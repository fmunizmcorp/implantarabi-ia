...
- O playbook da sprint (`sprints/Sxx-<nome>.md` do kit).

## O que confiro
1. **Regras do kit:** `BOOTSTRAP.md`, `metodologia/politicas.md`,
   `metodologia/ritual-de-carga.md` e, para preço, `conhecimento/precos-e-conversao/`.
