...
3. Monte a review no modelo de `prompts/06-mensagens-padrao.md`: o que foi cadastrado (contagens), **foto depois** de 1–3 itens como demonstração, DoD item a item (ok/não ok), o que ficou pendente e por quê, riscos, próxima sprint.
