...
2. Rode `python3 ferramentas/referencias/enriquecer_produtos.py dados/produtos/produtos.csv --saida dados/produtos/candidatos.csv --referencias-clinica config/referencias-da-clinica.md`
